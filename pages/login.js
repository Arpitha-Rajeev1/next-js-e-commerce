    ...
    await fetch(`${process.env.NEXT_PUBLIC_HOST}/api/login`, {
      ...
      .then(data => {
        if(data.success){
          ...
          toast.error('Sorry! No user found', {
            position: "top-right",
            autoClose: 3000,
            hideProgressBar: false,
            closeOnClick: true,
    ...
    <section className="text-gray-600 body-font">
      ...
      <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
        <div className="bg-gray-100 rounded-lg p-8 flex flex-col m-auto w-1/2 mt-5">
          <h2 className="text-gray-900 text-lg text-center font-medium title-font mb-5">Log in</h2>
          <form onSubmit={handleSubmit} method="POST">
            ...
            <Link href='/signup'><p className="text-s text-gray-500 mt-3">Don't have an account yet? Sign up</p></Link>
          </form>
        </div>
      </div>
    </section>
