        ...
        <section className="text-gray-600 body-font overflow-hidden">
            ...
            <div className="container px-5 py-24 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    <Image width={421} height={261} alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://m.media-amazon.com/images/I/81wu-09QZvL.jpg" />
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                            <div className="flex">
                                ...
                                {Object.keys(variants).includes('Black') && Object.keys(variants['Black']).includes(size) && <button onClick={() => refreshVariant(size, 'Black')} className={`border-2 ml-1 bg-black-700 rounded-full w-6 h-6 focus:outline-none ${color === 'Black' ? 'border-black' : 'border-gray-300'}`}></button>}
                            </div>
                        ...
                        <div className="flex">
                            ...
                            <button onClick={() => { buyNow() }} className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Buy now</button>
                            <button onClick={() => { addtoCart(slug, 1, 499, product.title, size, color) }} className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Add to cart</button>
                        </div>
                        <div className="pin mt-6 flex space-x-2 text-sm">
                            <input onChange={change} className='px-2 border-2 border-indigo-500 focus:outline-none' type="text" />
                            <button onClick={check} className='flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded'>Check</button>
                        </div>
